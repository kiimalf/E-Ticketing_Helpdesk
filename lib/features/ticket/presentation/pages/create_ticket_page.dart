...
class _CreateTicketPageState extends ConsumerState<CreateTicketPage> {
  ...
  Future<void> _onSubmit() async {
    ...
    final ok = await ref.read(createTicketProvider.notifier).submit(
    ...
    if (ok) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content:
            Text(err?.toString().replaceAll('Exception: ', '') ?? 'Gagal membuat tiket'),
        backgroundColor: Colors.red,
        behavior: SnackBarBehavior.floating,
      ));
    }
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final isImg = ['.jpg', '.jpeg', '.png', '.webp']
                          .any((e) =>
                              file.path.toLowerCase().endsWith(e));
                      return Stack(
                        children: [
                          Container(
                            width: 80, height: 80,
