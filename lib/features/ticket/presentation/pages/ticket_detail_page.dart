...
class _TicketDetailPageState extends ConsumerState<TicketDetailPage> {
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ...TicketStatus.values.map((s) => RadioListTile<TicketStatus>(
                  value: s,
    ...
    return Column(
      ...
      children: [
        ...
        if (ticket.assignedToName != null)
          _metaRow(Icons.assignment_ind_outlined,
  ...
  Widget _buildAttachments(List<TicketAttachmentModel> attachments) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Lampiran (${attachments.length})',
  ...
  Widget _buildTimeline(TicketModel ticket) {
    ...
    final steps = [
      ...
      (label: 'Sedang Ditangani', done: ticket.status != TicketStatus.open, date: null),
      (label: 'Diselesaikan',
        done: ticket.status == TicketStatus.resolved ||
              ticket.status == TicketStatus.closed,
        date: ticket.resolvedAt),
      (label: 'Ditutup', done: ticket.status == TicketStatus.closed, date: null),
    ];
                ...
                children: [
                  ...
                  if (!isLast)
                    Container(
                      width: 2, height: 28,
                      color: step.done
                          ? AppColors.statusResolved.withOpacity(0.4)
                          : theme.dividerColor,
                    ),
                ],
              ),
                    ...
                    children: [
                      Text(
                        ...
                        style: theme.textTheme.bodyMedium?.copyWith(
                          fontWeight:
                              step.done ? FontWeight.w600 : null,
                          color: step.done
                              ? null
    ...
    return Column(
      ...
      children: [
        ...
        if (ticket.comments.isEmpty)
          ...
          ...ticket.comments
              .map((c) => _buildCommentBubble(c, myId)),
      ],
    );
  }
