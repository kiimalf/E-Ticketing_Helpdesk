    ...
    return base.copyWith(
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: TextStyle(
          color: text1, fontSize: 18, fontWeight: FontWeight.w700, letterSpacing: -0.3,
        ),
      ),
      ...
      textTheme: base.textTheme.copyWith(
        ...
        titleMedium:    TextStyle(color: text1, fontWeight: FontWeight.w600, fontSize: 16),
        titleSmall:     TextStyle(color: text1, fontWeight: FontWeight.w600, fontSize: 14),
